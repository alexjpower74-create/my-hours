# My Hours
Read PLAN.md first; it is the contract. You own only your slice's files. Verify, commit only your paths. No visible Chrome; screenshot with pwshot. A check that cannot fail measured nothing: make each check red once.
